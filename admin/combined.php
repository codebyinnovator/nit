...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $button_text = isset($_POST['button_text']) ? mysqli_real_escape_string($conn, trim($_POST['button_text'])) : 'view courses';
    ...
    $button_color = isset($_POST['button_color']) ? mysqli_real_escape_string($conn, trim($_POST['button_color'])) : '#ffffff';
    ...
    if (empty($errors)) {
        if ($slide_id > 0) {
            ...
            $query = "INSERT INTO slider (title, description, button_text, content_position, text_color, title_color, button_text_color, image_path, sort_order, is_active)
                      VALUES ('$title', '$description', '$button_text', '$content_position', '$text_color', '$title_color', '$button_color', '$image_path', $new_sort_order, 1)";
            $result = mysqli_query($conn, $query);
            ...
            <div class="admin-container">                
                ...
                <div class="slider-management">
                    <div class="slides-list">
                        ...
                        <?php endforeach; ?>
                        <button class="add-slide-btn" onclick="window.location.href='?'">+ Add New Slide</button>
                    </div>
                    ...
                    <div class="slide-editor">
                        ...
                        <form id="slide-form" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="button_text" name="button_text" 
                                        value="<?php echo htmlspecialchars($current_slide['button_text']); ?>" 
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <label for="button_color">Button Text Color <span class="color-preview" id="button-color-preview" 
                                        style="background-color: <?php echo htmlspecialchars($current_slide['button_text_color']); ?>"></span></label>
                                    <input type="color" id="button_color" name="button_color" 
                                        value="<?php echo htmlspecialchars($current_slide['button_text_color']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="preview-slider">
                                <div class="preview-slide" id="preview-slide" 
                                    ...
                                    <div class="preview-content" id="preview-content" style="text-align: <?php echo htmlspecialchars($current_slide['content_position']); ?>">
                                        ...
                                        <a href="#" class="preview-btn" id="preview-button" style="color: <?php echo htmlspecialchars($current_slide['button_text_color']); ?>">
                                            <span id="preview-btn-text"><?php echo htmlspecialchars($current_slide['button_text']); ?></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
