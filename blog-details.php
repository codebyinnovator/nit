<!DOCTYPE html>
<!-- saved from url=(0064)https://demo.hasthemes.com/jones-preview/jones/blog-details.html -->
...
<head>
    ...
    <link rel="stylesheet" href="./blog-details_files/bootstrap.min.css">
    <link rel="stylesheet" href="./blog-details_files/meanmenu.css">
    <link rel="stylesheet" href="./blog-details_files/animate.css">
    <link rel="stylesheet" href="./blog-details_files/magnific-popup.css">
    <link rel="stylesheet" href="./blog-details_files/owl.carousel.min.css">
    <link rel="stylesheet" href="./blog-details_files/font-awesome.min.css">
    <link rel="stylesheet" href="./blog-details_files/style.css">
    <link rel="stylesheet" href="./blog-details_files/responsive.css">
    <script src="./blog-details_files/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
                        ...
                        <div class="header-top-right">
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#">English</a></li>
                                    <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#">Bangla</a></li>
                                    <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#">French</a></li>
                                </ul>
                            </div>
                            <a href="signup.php"><i class="fa fa-user"></i>sign up</a>
                            <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" class="modal-view button" data-toggle="modal" data-target="#login_box"><i class="fa fa-lock"></i>login</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-sm-7 col-xs-7">
                        <div class="logo">
                            <a href="https://demo.hasthemes.com/jones-preview/jones/index.html"><img src="./blog-details_files/logo.png" alt="Jones"></a>
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-10 col-sm-5 col-xs-5">
                        <div class="menu-container">
                            ...
                            <div class="search-content">
                                <a class="modal-view button" href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" data-toggle="modal" data-target="#search_box"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="blog-main-text">
                        ...
                        <div class="c-details-img">
                            <img src="admin/uploads/<?= $post['image'] ?>" height="700px" width="800px" alt="<?= htmlspecialchars($post['title']) ?>">
                        </div>
                        <div class="ht-blog-details-info">
                            <div class="b-d-img"><img src="./blog-details_files/s-1.jpg" alt=""></div>
                            <h5><?= htmlspecialchars($post['author']) ?></h5>
                            <h5><i class="fa fa-clock-o"></i><?= date('d M Y', strtotime($post['created_at'])) ?></h5>
                            <h5><i class="fa fa-comments"></i>89 Comments</h5>
                        </div>
                    </div>
                    <div class="b-details-text pb-80">
                        <div class="tab-text">
                            <p><?= nl2br(htmlspecialchars($post['content'])) ?></p>

                            <div class="ht-blog-video">
                                <iframe src="./blog-details_files/73050470.html" height="330"></iframe>
                            </div>
                            <div class="c-details-featue">
                                ...
                                <span><i class="fa fa-caret-right"></i>Vestibulum a lectus diam. Vestibulum venenatis rhoncus.</span>
                            </div>
                        </div>
                        <div class="c-details-share-wrapper">
                    ...
                    <div class="blog-comments">
                        <h3 class="sub-title">01 Comments</h3>
                        <div class="b-post-comment">
                            <div class="b-comment-img">
                                <img src="./blog-details_files/1.jpg" alt="">
                            </div>
                            <div class="b-post-text">
                                <div class="b-post-title">
                                    ...
                                    <div class="b-post-reply">
                                        <button><i class="fa fa-reply-all"></i></button>
                                    </div>
                                </div>
                                ...
                                <p>sapien, consequat ut mattis a, fringilla sit amet magna. Donec egestas gravid
                                    metusa porta Mauris vestibulum enim sed.</p>
                            </div>
                        </div>
                    </div>
                    <div class="blog-comments-form">
                        <h3 class="sub-title">Leave a Comments</h3>
                        <form action="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" method="post">
                            <div class="row">
                                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="ht-sidebar-wrapper">
                        <div class="ht-sidebar-widget">
                            <h4>Search Heare</h4>
                            <form action="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" method="post" class="sidebar-search">
                        ...
                        <div class="ht-sidebar-widget widget-style-2">
                            ...
                            <ul class="s-widget-list list-2">
                                <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#"><i class="fa fa-caret-right"></i>Secience</a></li>
                                <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#"><i class="fa fa-caret-right"></i>Graphic Design</a></li>
                                <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#"><i class="fa fa-caret-right"></i>Mobile Apps Drsign</a></li>
                                <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#"><i class="fa fa-caret-right"></i>Business</a></li>
                                <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#"><i class="fa fa-caret-right"></i>Web Design</a></li>
                                <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#"><i class="fa fa-caret-right"></i>Wordpress</a></li>
                            </ul>
                        </div>
                        <div class="ht-sidebar-widget widget-style-2">
                            <h4>Latest Courses</h4>
                            <div class="ht-sidebar-post">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html"><img src="./blog-details_files/3.jpg" alt=""></a>
                                <div class="ht-post-text">
                                    <span class="ht-s-post-title">Business <span>$80.00</span></span>
                                    <h4><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">Lorem ipsum dolor sit amet cosectetur.</a></h4>
                                </div>
                            </div>
                            <div class="ht-sidebar-post">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html"><img src="./blog-details_files/4.jpg" alt=""></a>
                                <div class="ht-post-text">
                                    <span class="ht-s-post-title">Sceince <span>free</span></span>
                                    <h4><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">Lorem ipsum dolo sitsi dole.</a></h4>
                                </div>
                            </div>
                            <div class="ht-sidebar-post">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html"><img src="./blog-details_files/5.jpg" alt=""></a>
                                <div class="ht-post-text">
                                    <span class="ht-s-post-title">Business <span>$90.00</span></span>
                                    <h4><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">Lorem ipsum dolo sist.</a></h4>
                                </div>
                            </div>
                        </div>
                        <div class="ht-sidebar-widget widget-style-2 bg-green">
                            <h4>Ask any question?</h4>
                            <form action="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" method="post" class="question-form">
                                <input type="text" placeholder="Name" name="name">
                        ...
                        <div class="ht-sidebar-widget widget-style-2">
                            <h4>Latest Posts</h4>
                            <div class="ht-sidebar-post">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html"><img src="./blog-details_files/6.jpg" alt=""></a>
                                <div class="ht-post-text">
                                    <span class="ht-s-post-title">10 March 2017</span>
                                    <h4><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">Lorem ipsum dolor sit amet cosectetur.</a></h4>
                                </div>
                            </div>
                            <div class="ht-sidebar-post">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html"><img src="./blog-details_files/7.jpg" alt=""></a>
                                <div class="ht-post-text">
                                    <span class="ht-s-post-title">10 March 2017</span>
                                    <h4><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">Lorem ipsum dolo sitsi dole.</a></h4>
                                </div>
                            ...
                            <div class="ht-sidebar-post">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html"><img src="./blog-details_files/8.jpg" alt=""></a>
                                <div class="ht-post-text">
                                    <span class="ht-s-post-title">10 March 2017</span>
                                    <h4><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">Lorem ipsum dolo sist.</a></h4>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-widget">
                            <div class="footer-logo">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/index.html"><img src="./blog-details_files/footer-logo.png" alt="Jones"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="single-footer-widget">
                            ...
                            <div class="footer-post-item">
                                <a href="">
                                    <img src="./blog-details_files/1(1).jpg" alt="">
                                </a>
                            ...
                            <div class="footer-post-item">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">
                                    <img src="./blog-details_files/2.jpg" alt="">
                                </a>
                                <div class="footer-post-text">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="search-pop-up" action="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" method="post">
                        <input type="text" placeholder="Search..........">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="signup-form-container sign-up-box">
                        ...
                        <form action="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" method="post" class="signup-form">
                            ...
                            <div class="from-wrap">
                                ...
                                <div class="form-right"><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#">Lost Your Password?</a></div>
                            </div>
    ...
    <script src="./blog-details_files/jquery-1.12.4.min.js"></script>
    <script src="./blog-details_files/bootstrap.min.js"></script>
    <script src="./blog-details_files/jquery.meanmenu.js"></script>
    <script src="./blog-details_files/jquery.magnific-popup.js"></script>
    <script src="./blog-details_files/jquery.countdown.min.js"></script>
    <script src="./blog-details_files/ajax-mail.js"></script>
    <script src="./blog-details_files/owl.carousel.min.js"></script>
    <script src="./blog-details_files/plugins.js"></script>
    <script src="./blog-details_files/main.js"></script><a id="scrollUp" href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-long-arrow-up"></i></a>
