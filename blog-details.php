                                ...
                                <div class="main-menu mean-menu">
                                    <nav style="display: block;">
                                        <ul>
                                            ...
                                            <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#">Buy Now</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                ...
                <div class="col-md-8">
                    <div class="blog-main-text">
                        ...
                        <div class="c-details-img">
                            <img src="admin/uploads/<?= $post['image'] ?>" alt="<?= htmlspecialchars($post['title']) ?>">
                        </div>
                        <div class="ht-blog-details-info">
                            <div class="b-d-img"><img src="assets/images/default-author.jpg" alt=""></div>
                        ...
                        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                            ...
                            <div class="newsletter-form mc_embed_signup">
                                <form action="http://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate="">
                                    ...
                                    <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#" class="default-btn">Subscribe us</a>
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-3 col-md-2 col-sm-6 col-xs-12">
                            <div class="single-footer-widget">
                                ...
                                <ul class="footer-widget-list">
                                    ...
                                    <li><a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html#">FAQ</a></li>
                                </ul>
                            </div>
                        </div>
