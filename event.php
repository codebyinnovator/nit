<!DOCTYPE html>
<!-- saved from url=(0057)https://demo.hasthemes.com/jones-preview/jones/event.html -->
...
<head>
    ...
    <link rel="stylesheet" href="./event_files/bootstrap.min.css">
    <link rel="stylesheet" href="./event_files/meanmenu.css">
    <link rel="stylesheet" href="./event_files/animate.css">
    <link rel="stylesheet" href="./event_files/magnific-popup.css">
    <link rel="stylesheet" href="./event_files/owl.carousel.min.css">
    <link rel="stylesheet" href="./event_files/font-awesome.min.css">
    <link rel="stylesheet" href="./event_files/style.css">
    <link rel="stylesheet" href="./event_files/responsive.css">
    <script src="./event_files/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
                        ...
                        <div class="header-top-right">
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="https://demo.hasthemes.com/jones-preview/jones/event.html#">English</a></li>
                                    <li><a href="https://demo.hasthemes.com/jones-preview/jones/event.html#">Bangla</a></li>
                                    <li><a href="https://demo.hasthemes.com/jones-preview/jones/event.html#">French</a></li>
                                </ul>
                            </div>
                            <a href="signup.php"><i class="fa fa-user"></i>sign up</a>
                            <a href="https://demo.hasthemes.com/jones-preview/jones/event.html#" class="modal-view button" data-toggle="modal" data-target="#login_box"><i class="fa fa-lock"></i>login</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-sm-7 col-xs-7">
                        <div class="logo">
                            <a href="https://demo.hasthemes.com/jones-preview/jones/index.html"><img src="./event_files/logo.png" alt="Jones"></a>
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-10 col-sm-5 col-xs-5">
                        <div class="menu-container">
                            ...
                            <div class="search-content">
                                <a class="modal-view button" href="https://demo.hasthemes.com/jones-preview/jones/event.html#" data-toggle="modal" data-target="#search_box"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Breadcrumb Area End -->
    <!-- Events Area Start -->
    <section class="event-area pb-150 event-three">
        <div class="container">
            <div class="row">
                <?php
                ...
                while ($row = $result->fetch_assoc()) {
                    // Format date
                    $date = date("d", strtotime($row['event_time_from']));
                    $month = date("F", strtotime($row['event_time_from']));
                ?>
                    <div class="col-xs-12">
                        <div class="ht-single-event">
                            <div class="ht-event-image" style="width: 300px; height: 200px;">
                                <a href="#"><img src="../nit-main/creativetimofficial-material-dashboard-9a72e78/uploads/<?= htmlspecialchars($row['event_photo']) ?>" alt="<?= htmlspecialchars($row['event_title']) ?>"></a>
                            </div>
                            <div class="ht-event-text">
                                <div class="ht-event-meta">
                                    <span class="event-date"><?= $date ?><span><?= $month ?></span></span>
                                    <div class="event-title">
                                        <h4><a href="#"><?= htmlspecialchars($row['event_title']) ?></a></h4>
                                        <span><i class="fa fa-clock-o"></i> <?= htmlspecialchars($row['event_time_from']) ?> - <?= htmlspecialchars($row['event_time_to']) ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                        ...
                        <div class="newsletter-form mc_embed_signup">
                            <form action="http://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate="">
                                ...
                                <a href="https://demo.hasthemes.com/jones-preview/jones/event.html#" class="default-btn">Subscribe us</a>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-widget">
                            <div class="footer-logo">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/index.html"><img src="./event_files/footer-logo.png" alt="Jones"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-3 col-md-2 col-sm-6 col-xs-12">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-widget-list">
                                ...
                                <li><a href="https://demo.hasthemes.com/jones-preview/jones/event.html#">FAQ</a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="search-pop-up" action="https://demo.hasthemes.com/jones-preview/jones/event.html#" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="signup-form-container sign-up-box">
                        ...
                        <form action="https://demo.hasthemes.com/jones-preview/jones/event.html#" method="post" class="signup-form">
                            ...
                            <div class="from-wrap">
                                ...
                                <div class="form-right"><a href="https://demo.hasthemes.com/jones-preview/jones/event.html#">Lost Your Password?</a></div>
                            </div>
    ...
    <script src="./event_files/jquery-1.12.4.min.js"></script>
    <script src="./event_files/bootstrap.min.js"></script>
    <script src="./event_files/jquery.meanmenu.js"></script>
    <script src="./event_files/jquery.magnific-popup.js"></script>
    <script src="./event_files/jquery.countdown.min.js"></script>
    <script src="./event_files/ajax-mail.js"></script>
    <script src="./event_files/owl.carousel.min.js"></script>
    <script src="./event_files/plugins.js"></script>
    <script src="./event_files/main.js"></script><a id="scrollUp" href="https://demo.hasthemes.com/jones-preview/jones/event.html#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-long-arrow-up"></i></a>
