...
<head>
    ...
    <link rel="stylesheet" href="./signup_files/bootstrap.min.css">
    <link rel="stylesheet" href="./signup_files/meanmenu.css">
    <link rel="stylesheet" href="./signup_files/animate.css">
    <link rel="stylesheet" href="./signup_files/magnific-popup.css">
    <link rel="stylesheet" href="./signup_files/owl.carousel.min.css">
    <link rel="stylesheet" href="./signup_files/font-awesome.min.css">
    <link rel="stylesheet" href="./signup_files/style.css">
    <link rel="stylesheet" href="./signup_files/responsive.css">
    <script src="./signup_files/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-sm-7 col-xs-7">
                        <div class="logo">
                            <a href="https://demo.hasthemes.com/jones-preview/jones/index.html"><img src="./signup_files/logo.png" alt="Jones"></a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="signup-form-container sign-up-box">
                        ...
                        <!-- Show Errors -->
                        <form action="admin/actions/signup.php" method="post" class="signup-form" required>
                            ...
                            <input type="password" placeholder="Repeat Password" name="r_password" required>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="signup-links-container sign-up-box">
                        <h3 class="sub-title">Sign Up with social Network</h3>
    ...
    <section class="newsletter-area pt-150 text-center">
        <div class="container">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-widget">
                            <div class="footer-logo">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/index.html"><img src="./signup_files/footer-logo.png" alt="Jones"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="footer-post-item">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">
                                    <img src="./signup_files/1.jpg" alt="">
                                </a>
                            ...
                            <div class="footer-post-item">
                                <a href="https://demo.hasthemes.com/jones-preview/jones/blog-details.html">
                                    <img src="./signup_files/2.jpg" alt="">
                                </a>
                                <div class="footer-post-text">
    ...
    <script src="./signup_files/jquery-1.12.4.min.js"></script>
    <script src="./signup_files/bootstrap.min.js"></script>
    <script src="./signup_files/jquery.meanmenu.js"></script>
    <script src="./signup_files/jquery.magnific-popup.js"></script>
    <script src="./signup_files/jquery.countdown.min.js"></script>
